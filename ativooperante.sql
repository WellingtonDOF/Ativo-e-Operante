...
CREATE TABLE public.denuncia (
    ...
    tip_id integer,
    usu_id integer,
    den_image character varying(40)
);
...
CREATE TABLE public.usuario (
    ...
    usu_cpf character varying(40) NOT NULL,
...
INSERT INTO public.denuncia VALUES (1, 'semaforo quebrado', 'semaforo da av da saudede perto do campua I da Unoeste não está funcionando', 4, 4, '2023-05-12 00:00:00', 1, 2,'\image\Sequencia_Wellington.png');
